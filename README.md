...
- Request
  ...
  - Method: POST
  - URL: /api/spots/:spotId/image-create
  - Headers:
    - Content-Type: application/json
  - Body:
...
- Request
  ...
  - Method: POST
  - URL: api/reviews/spot/:spotId/create
  - Headers:
    - Content-Type: application/json
  - Body:
...
- Request
  ...
  - Method: POST
  - URL: /api/reviews/:reviewId/image-create
  - Headers:
    - Content-Type: application/json
  - Body:
